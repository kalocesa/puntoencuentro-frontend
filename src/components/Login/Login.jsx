    ...
    <div className="relative h-screen overflow-hidden flex items-center justify-center px-4">
      ...
      <div className="relative z-20 bg-black/90 rounded-2xl p-8 max-w-[550px] w-full">
        ...
        <form onSubmit={handleSubmit} className="pb-10">
          ...
          <button
            type="submit"
            className="w-3/4 block mx-auto bg-[#9e0059] py-2 px-4 rounded-full hover:bg-[#9e0059]/30 transition duration-300 cursor-pointer"
          >
            Inicia sesión
          </button>
        </form>
        <p className="text-center text-xs md:text-sm text-white mt-4">
          ¿Aun no eres miembro?{" "}
          <Link to="/signup" className="text-[#ff5400] hover:underline">
            Regístrate aquí
          </Link>
        </p>
      </div>
